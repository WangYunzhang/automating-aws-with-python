...
region_to_endpoint = {
    ...
    'cn-north-1': Endpoint('China (Beijing)', 's3-website.cn-north-1.amazonaws.com.cn', None)
}


def known_region(region):
    """Return true if the region is a known region."""
    return region in region_to_endpoint


def get_endpoint(region):
    """Get the S3 website endpoint for a given region."""
